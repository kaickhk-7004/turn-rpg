...
const BASE_ITEMS = {
  weapon: [
    { name: '장검', emoji: '🗡️', stat: 'atk' },
    { name: '전투도끼', emoji: '🪓', stat: 'atk' },
    { name: '마법지팡이', emoji: '🪄', stat: 'mag' },
    { name: '단검', emoji: '🔪', stat: 'atk' },
  ],
  armor: [
    { name: '판금갑옷', emoji: '🛡️', stat: 'def' },
    { name: '가죽갑옷', emoji: '🥋', stat: 'def' },
    { name: '로브', emoji: '🧥', stat: 'def' },
  ],
  accessory: [
    { name: '반지', emoji: '💍', stat: 'crit' },
    { name: '목걸이', emoji: '📿', stat: 'mag' },
    { name: '부적', emoji: '🧿', stat: 'hp' },
  ],
};
...
// ── 몬스터 ──
const ENEMIES = [
  { name: '고블린', emoji: '👺', hp: 45, atk: 10, def: 4, mag: 0, spd: 9, minFloor: 1 },
  { name: '늑대', emoji: '🐺', hp: 55, atk: 12, def: 3, mag: 0, spd: 13, minFloor: 1 },
  { name: '슬라임', emoji: '🟢', hp: 70, atk: 8, def: 8, mag: 0, spd: 5, minFloor: 1 },
  { name: '해골병사', emoji: '💀', hp: 65, atk: 14, def: 7, mag: 0, spd: 8, minFloor: 3 },
  { name: '오크', emoji: '👹', hp: 90, atk: 17, def: 9, mag: 0, spd: 7, minFloor: 4 },
  { name: '박쥐떼', emoji: '🦇', hp: 50, atk: 13, def: 2, mag: 0, spd: 17, minFloor: 4 },
  { name: '암흑술사', emoji: '🧙', hp: 70, atk: 6, def: 5, mag: 18, spd: 10, minFloor: 6 },
  { name: '거미여왕', emoji: '🕷️', hp: 85, atk: 16, def: 8, mag: 6, spd: 12, minFloor: 7 },
  { name: '트롤', emoji: '🧌', hp: 140, atk: 20, def: 12, mag: 0, spd: 5, minFloor: 8 },
  { name: '가고일', emoji: '🗿', hp: 110, atk: 18, def: 16, mag: 4, spd: 8, minFloor: 10 },
  { name: '망령기사', emoji: '⚔️', hp: 120, atk: 24, def: 12, mag: 8, spd: 11, minFloor: 12 },
  { name: '키메라', emoji: '🦁', hp: 150, atk: 26, def: 12, mag: 12, spd: 13, minFloor: 14 },
];

const BOSSES = [
  { name: '고블린 족장', emoji: '👺', hp: 260, atk: 20, def: 10, mag: 0, spd: 10 },
  { name: '해골 군주', emoji: '☠️', hp: 380, atk: 26, def: 14, mag: 10, spd: 11 },
  { name: '심연의 마녀', emoji: '🧙‍♀️', hp: 460, atk: 14, def: 12, mag: 30, spd: 13 },
  { name: '서리 거인', emoji: '🧊', hp: 650, atk: 34, def: 20, mag: 8, spd: 8 },
  { name: '흑염룡', emoji: '🐉', hp: 900, atk: 42, def: 24, mag: 24, spd: 14 },
];
